...
out_mat_list = foreach(i = 1:length(param_list_list),
    ...
    while (cur_gen < max_gen) {
        ...
        if(equilibrium_threshold != 0) {
            ...
            } else if (cur_gen >= (burnin+inject_delay)){
        ...
        if(record_gen != 0 & cur_gen >= (burnin+inject_delay)) {
            ...
            if(cur_gen == (burnin + inject_delay + 100) & record_gen < 10) {record_gen = 10}
            if(cur_gen == (burnin + inject_delay + 1000) & record_gen < 100) {record_gen = 100}
            if(cur_gen == (burnin + inject_delay + 10000) & record_gen < 1000) {record_gen = 1000}
            
            if(cur_gen %% record_gen == 0) {
